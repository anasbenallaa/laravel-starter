...
For UI changes, check light mode, dark mode and 390px width in the browser.
...
3. **Domain docs:** update `docs/ui-guidelines.md`, `docs/authorization.md`, `docs/activity-log.md` or `docs/notifications.md` when you change a documented pattern.
